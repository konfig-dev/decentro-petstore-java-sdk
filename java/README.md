...
```xml
<dependency>
  <groupId>decentro.tech</groupId>
  <artifactId>petstore-java-sdk</artifactId>
...
dependencies {
   implementation "decentro.tech:petstore-java-sdk:1.0.0"
}
```
...
* `target/petstore-java-sdk-1.0.0.jar`
* `target/lib/*.jar`
...
## Documentation for Models
 ...
 - [Pet](docs/Pet.md)
 - [Tag](docs/Tag.md)
 - [UpdatePetWithFormRequest](docs/UpdatePetWithFormRequest.md)
