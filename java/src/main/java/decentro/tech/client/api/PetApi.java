...
public class PetApi {
    ...
    private okhttp3.Call addPetAsync(Pet pet, final ApiCallback<Void> _callback) throws ApiException {
    ...
    private okhttp3.Call updatePetAsync(Pet pet, final ApiCallback<Void> _callback) throws ApiException {
    ...
    private okhttp3.Call updatePetWithFormCall(Long petId, String name, String status, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    private okhttp3.Call updatePetWithFormAsync(Long petId, String name, String status, final ApiCallback<Void> _callback) throws ApiException {
    ...
    public class APIupdatePetWithFormRequest {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            return updatePetWithFormAsync(petId, name, status, _callback);
        }
    }
